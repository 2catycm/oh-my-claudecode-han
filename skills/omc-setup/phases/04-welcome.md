...
- /omc-han:team 3:executor "fix all TypeScript errors"
- /omc-han:team 5:debugger "fix build errors in src/"
...
MCP SERVERS:
Run /omc-han:mcp-setup to add tools like web search, GitHub, etc.
