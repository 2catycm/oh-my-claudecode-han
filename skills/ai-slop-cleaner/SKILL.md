...
description: 清理 AI 生成的代码冗余 — 回归安全、删除优先的工作流，含可选的仅评审模式
level: 3
---
...
- Good fit: `omc-han:ai-slop-cleaner skills/ralph/SKILL.md skills/ai-slop-cleaner/SKILL.md`
...
- `/omc-han:ai-slop-cleaner <target>`
- `/omc-han:ai-slop-cleaner <target> --review`
- `/omc-han:ai-slop-cleaner <file-a> <file-b> <file-c>`
