...
Skills are reusable workflow templates that can be invoked via `/omc-han:skill-name`. Each skill provides:
...
- Test skill invocation with `/omc-han:skill-name`
