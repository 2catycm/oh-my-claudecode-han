...
description: 用自然语言配置通知集成（Telegram、Discord、Slack）
triggers:
...
To reconfigure: /omc-han:configure-notifications telegram
To configure Discord: /omc-han:configure-notifications discord
To configure Slack: /omc-han:configure-notifications slack
```
...
To reconfigure: /omc-han:configure-notifications discord
To configure Telegram: /omc-han:configure-notifications telegram
To configure Slack: /omc-han:configure-notifications slack
```
...
To reconfigure: /omc-han:configure-notifications slack
To configure Discord: /omc-han:configure-notifications discord
To configure Telegram: /omc-han:configure-notifications telegram
```
...
- `/omc-han:configure-openclaw` — Configure OpenClaw gateway integration
