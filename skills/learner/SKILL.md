...
> Deprecated compatibility alias: use `/omc-han:skillify` for new skill extraction workflows. This file remains for internal implementation/history and compatibility.
...
- /omc-han:note - Save quick notes that survive compaction (less formal than skills)
- /omc-han:ralph - Start a development loop with learning capture
