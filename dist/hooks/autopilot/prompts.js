...
Task(subagent_type="omc-han:executor-low", model="haiku", prompt="...")

// For standard implementation (feature, multiple methods)
Task(subagent_type="omc-han:executor", model="sonnet", prompt="...")

// For complex work (architecture, debugging, refactoring)
Task(subagent_type="omc-han:executor-high", model="opus", prompt="...")
\`\`\`
...
\`\`\`
Task(
  subagent_type="omc-han:architect-low",
  model="haiku",
...
\`\`\`
Task(
  subagent_type="omc-han:debugger",
  model="sonnet",
...
// Security Review
Task(
  subagent_type="omc-han:security-reviewer",
  model="opus",
...
// Code Quality Review
Task(
  subagent_type="omc-han:code-reviewer",
  model="opus",
