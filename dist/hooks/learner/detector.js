...
Would you like me to extract this as a learned skill? Type \`/omc-han:skillify\` to save it (\`/omc-han:learner\` remains as a deprecated compatibility alias), or continue with your current task.
`.trim();
}
