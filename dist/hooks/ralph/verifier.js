 ...
 * 4. If architect approves -> truly complete, use /omc-han:cancel to exit
...
3. **Based on ${criticLabel}'s response:**
   - If APPROVED: Output the exact correlated approval tag \`${approvalTag}\`, then run \`/omc-han:cancel\` to cleanly exit
...
4. After ${criticLabel} approves, run \`/omc-han:cancel\` to cleanly exit
