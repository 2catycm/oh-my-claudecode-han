...
describe('keyword-detector.mjs — pasted system-echo re-entry guard', () => {
    ...
    it('does NOT re-activate ralph for a bare [RALPH LOOP - ITERATION] paste', () => {
        ...
        const prompt = [
            ...
            'When FULLY complete (after Architect verification), run /omc-han:cancel to cleanly exit ralph mode and clean up all state files. If cancel fails, retry with /omc-han:cancel --force.',
    ...
    it('does NOT re-activate ralph when the prompt is a Stop hook feedback block', () => {
        ...
        const prompt = [
            ...
            'When FULLY complete (after Architect verification), run /omc-han:cancel ...',
    ...
    // `When FULLY complete`, and `run /omc-han:cancel`, which meant
