...
describe('trace-tools', () => {
    ...
    describe('agent breakdown in summary', () => {
        ...
        it('should show execution flow section', async () => {
            ...
            appendReplayEvent(testDir, 'flow-exec', { agent: 'system', event: 'skill_invoked', skill_name: 'omc-han:plan' });
            ...
            expect(text).toContain('omc-han:plan invoked');
    ...
    describe('skills_invoked in summary', () => {
        it('should show skills invoked via Skill tool', async () => {
            appendReplayEvent(testDir, 'sk-sess', { agent: 'system', event: 'skill_invoked', skill_name: 'omc-han:plan' });
            appendReplayEvent(testDir, 'sk-sess', { agent: 'system', event: 'skill_invoked', skill_name: 'omc-han:ultrawork' });
            ...
            expect(text).toContain('omc-han:plan');
            expect(text).toContain('omc-han:ultrawork');
        });
        it('should format skill_invoked in timeline', async () => {
            appendReplayEvent(testDir, 'sk-tl', { agent: 'system', event: 'skill_invoked', skill_name: 'omc-han:plan' });
        ...
        it('should include skill_invoked in skills filter', async () => {
            appendReplayEvent(testDir, 'sk-flt', { agent: 'system', event: 'skill_invoked', skill_name: 'omc-han:plan' });
