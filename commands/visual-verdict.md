...
This compatibility command keeps `/omc-han:visual-verdict` available without loading the full `visual-verdict` skill description in every Claude Code session.
