...
This compatibility command keeps `/omc-han:external-context` available without loading the full `external-context` skill description in every Claude Code session.
